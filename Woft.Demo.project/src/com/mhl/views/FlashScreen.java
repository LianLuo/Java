...
public class FlashScreen extends javax.swing.JWindow implements Runnable{
	...
	public static void main(String[] args){
		Thread t = new Thread(new FlashScreen());
		t.start();
	}
	
	public FlashScreen(){
		this.setLayout(null);
		ImageIcon imageIcon = new ImageIcon("Resources/images/flashscreen.jpg");
